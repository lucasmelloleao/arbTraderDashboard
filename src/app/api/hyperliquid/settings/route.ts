...
export const POST = withAuth(async (req: NextRequest, userId: string) => {
  try {
    ...
    const allowed = ['isScanningEnabled', 'tradeSize', 'minFundingRatePct', 'minVolume24hUSD', 'maxStrategiesPerScan', 'maxDailyLoss', 'maxPortfolioCapUSD', 'takeProfitPricePct', 'trailingStopPct'];
    const update: any = {};
