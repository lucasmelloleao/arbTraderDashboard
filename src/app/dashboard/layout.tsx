...
import { Wallet, Zap, LayoutDashboard, LogOut, History, Activity, TrendingUp, User, Menu, X, CalendarRange, Terminal, ShieldAlert, ChevronDown, HelpCircle, Globe, Waves } from 'lucide-react';
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const links = [
    ...
    { href: '/dashboard/hyperliquid', label: 'Lyquid', icon: Waves },
